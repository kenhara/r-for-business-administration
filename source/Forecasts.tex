...
\begin{figure}[h!]
\includegraphics[keepaspectratio=true,height=1.10\textheight,width=1.00\textwidth,angle=0]{summary_freeny.png}
...
% LEFT OFF HERE, RESUME HERE NEXT TIME
% THIS IS OLD WARPBREAKS ANALYSIS 
