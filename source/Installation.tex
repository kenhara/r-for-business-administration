...
While installation is fairly simple, it does require some attention to detail to make sure that everything installs properly.
...
\subsection{Installing R Commander\footnote{Find more detailed installation instructions online here: \texttt{http://socserv.mcmaster.ca/jfox/Misc/Rcmdr/installation-notes.html}}}
\begin{enumerate}
...
\subsection{Starting R Commander}
