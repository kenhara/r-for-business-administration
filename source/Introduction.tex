...
Some complement the series 'data', 'information' and 'knowledge' with 'wisdom', which would mean the status of a person in possession of a certain 'knowledge' who also knows under which circumstances is good to use it."\footnote{Source: \url{https://en.wikipedia.org/w/index.php?title=Data&oldid=733102554}}
